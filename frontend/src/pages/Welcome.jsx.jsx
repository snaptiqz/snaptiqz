    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-[#020308] text-white font-sans relative overflow-hidden px-4">
      ...
      {showSplash ? (
        <div className="flex flex-col items-center z-10">
          <img src={logo} alt="Snaptiqz Logo" className="w-6 h-6 mb-8" />
          <img
            src={avatar}
            alt="User"
        ...
        // Role Selection
        <div className="flex flex-col items-center z-10 max-w-md w-full space-y-6">
          ...
          <div className="w-full space-y-4 mt-2">
            <button className="w-full flex items-center gap-4 p-4 border border-white rounded-lg bg-white/5 hover:bg-white/10 transition">
